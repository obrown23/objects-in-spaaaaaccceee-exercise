...
console.log(constsystem.mercury.mass)

// 2. console.log the eccentricity of Venus

console.log(constsystem.venus.eccentricity)
...
let jupiter "momentum" = (system.jupiter.velocity * system.jupiter.mass);

let pluto "momentum" = (system.jupiter.velocity * system.pluto.mass);

console.log(jupiter "momentum" - pluto "momentum")
